  ...
  return (
    <div class="flex flex-wrap items-center justify-center w-screen h-screen relative">
      ...
      <Show when={isShowTitle()}>
        <div class="relative z-10 flex flex-col flex-wrap items-center">
          ...
          <p class="text-xl text-neutral-300 font-medium w-full max-w-[50vw] text-center pt-10">
            Series A closing - last chance to invest
          </p>

          <p class="text-3xl text-neutral-300 font-medium w-full max-w-[50vw] text-center pt-5">
